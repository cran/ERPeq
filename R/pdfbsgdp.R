...
#' @title Probability density function of the Birnbaum-Saunders-Generalized Pareto distribution
...
#'
#' @return return the value of the pdf of the Birnbaum-Saunders-Generalized Pareto  distribution.
#' @export
