#' @title Cumulative distribution function of the inverse Weibull distribution
#'
...
#'
#' @return return the value of the cdf of the inverse Weibull distribution
#' @export
#' @import stats
